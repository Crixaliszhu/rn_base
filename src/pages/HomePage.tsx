...
const eventEmitter = HybridBridge ? new NativeEventEmitter(HybridBridge) : null;
...
const HomePage: React.FC<Props> = (props) => {
  ...
  const checkUpdate = async () => {
    ...
    } catch (e: any) { Alert.alert('检查失败', e.message); }
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.row}>
        <TouchableOpacity style={styles.halfBtn} onPress={saveData}><Text style={styles.btnText}>写入</Text></TouchableOpacity>
        <TouchableOpacity style={styles.halfBtn} onPress={readData}><Text style={styles.btnText}>读取</Text></TouchableOpacity>
      </View>
